...
public:
  ...
  RC init(const char *name, AttrType attr_type, int attr_offset,
      int attr_len, bool visible, AggrType aggr_type = AggrType::NOAGGR);
...
protected:
  ...
  int attr_len_;
  bool visible_;
  AggrType aggr_type_ = AggrType::NOAGGR;
};
